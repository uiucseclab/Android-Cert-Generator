...
.method public static b(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
    .locals 1
...
.method public static getInBitmapFromOptions(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1
    .annotation build Lcom/facebook/common/internal/DoNotStrip;
    .end annotation
...
.method public static hookDecodeByteArray([BII)Landroid/graphics/Bitmap;
    ...
    .line 135
    invoke-static {p0, p1, p2}, Lcom/facebook/common/webp/WebpSupportStatus;->c([BII)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p0, p1, p2}, Lcom/facebook/common/webp/WebpSupportStatus;->a([BII)Z
    ...
    .line 136
    invoke-static {v0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->getScaleFromOptions(Landroid/graphics/BitmapFactory$Options;)F

    move-result v5

    invoke-static {v0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->getInBitmapFromOptions(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v6

    invoke-static {v0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->getInTempStorageFromOptions(Landroid/graphics/BitmapFactory$Options;)[B
    ...
    invoke-static/range {v1 .. v7}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->nativeDecodeByteArray([BIILandroid/graphics/BitmapFactory$Options;FLandroid/graphics/Bitmap;[B)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 144
    invoke-static {v1, v0}, Lcom/facebook/webpsupport/WebpBitmapFactoryImpl;->b(Landroid/graphics/Bitmap;Landroid/graphics/BitmapFactory$Options;)V
...
.method public static hookDecodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, v4, v5}, Lcom/facebook/common/webp/WebpSupportStatus;->c([BII)Z
    ...
    invoke-static {v3, v4, v5}, Lcom/facebook/common/webp/WebpSupportStatus;->a([BII)Z
...
.method public static hookDecodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 186
    invoke-static {v1, v3, v4}, Lcom/facebook/common/webp/WebpSupportStatus;->c([BII)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-static {v1, v3, v4}, Lcom/facebook/common/webp/WebpSupportStatus;->a([BII)Z
...
.method public static native nativeDecodeByteArray([BIILandroid/graphics/BitmapFactory$Options;FLandroid/graphics/Bitmap;[B)Landroid/graphics/Bitmap;
    .annotation build Lcom/facebook/common/internal/DoNotStrip;
    .end annotation
.end method
